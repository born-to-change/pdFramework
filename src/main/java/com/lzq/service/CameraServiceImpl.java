...
public class CameraServiceImpl implements CameraService{
    ...
    public Cam getCamByBingingFileId(Integer proId,Integer bingingFileId){
        Cam cam;
        try{
            cam = cameraMapper.getCamByBingingFileId(proId,bingingFileId);
        }catch (Exception e) {
            log.warn("get cams by bingingFileId and proid failed", e);
            return null;
        }
        return cam;
    }
